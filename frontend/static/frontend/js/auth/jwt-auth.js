 ...
 * 
 * Handles token-based authentication for both web and Cordova apps.
...
// API base URL - configurable for Cordova
let API_BASE_URL = '';

/**
 * Set the API base URL (for Cordova pointing to deployed server)
 */
...
// Export for use in Cordova config
export default {
    setApiBaseUrl,
    getAccessToken,
    getRefreshToken,
